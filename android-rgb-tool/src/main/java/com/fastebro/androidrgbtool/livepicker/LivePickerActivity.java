...
public class LivePickerActivity extends AppCompatActivity {
     ...
     */
    private LivePickerTextureView mTextureView;
    ...
    private void showToast(final String text) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(LivePickerActivity.this, text, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void initViews() {
        ...
        mTextureView = (LivePickerTextureView) findViewById(R.id.live_picker_texture);
...
//                }
    ...
    /**
     * Opens the camera specified by {@link LivePickerActivity#mCameraId}.
     */
